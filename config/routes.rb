Rails.application.routes.draw do
  ...
  get '/freelancers/new' => 'freelancers#new', as: 'new_freelancer'
  post '/freelancers' => 'freelancers#create'
  get '/freelancers/:id' => 'freelancers#show' , as: 'freelancer'
  get '/freelancers/:id/edit' => 'freelancers#edit', as: 'edit_freelancer'
  patch '/freelancers/:id' => 'freelancers#update'
  delete '/freelancers/:id' => 'freelancers#destroy'
